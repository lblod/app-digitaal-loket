...
async function generate() {
  const bedienarenURIs = (
    await mas.querySudo(queries.allBedienaren())
  ).results.bindings.map((b) => b.bedienaar.value);
  let collectedSubjects = bedienarenURIs;
  let collectedData = [];
