...
export default {
  ...
  execute: async () => {
    const reportData = {
      ...
      description: 'GzG subsidy forms of oproep 4, step 1',
      filePrefix: 'gzgSubsidieOproepFourReport'
    };
      ...
      WHERE {
        {
          ...
          ?form dct:isPartOf/dct:references <http://data.lblod.info/id/subsidy-procedural-steps/64afeb2f-9052-492e-ad45-eb689b5a8d1d> ;
            adms:status ?status;
