...
export default {
  ...
  execute: async () => {
    const reportData = {
      title: 'List of GzG Report oproep 2, step 1',
      description: 'GzG subsidy forms of oproep 2, step 1',
      filePrefix: 'gzgSubsidieOproepTwoReport'
    };
      ...
      WHERE {
        {
          ...
          ?form dct:isPartOf/dct:references <http://data.lblod.info/id/subsidy-procedural-steps/017fe3be-07c7-4341-9c1d-e322d6c41fa1> ;
            adms:status ?status;
