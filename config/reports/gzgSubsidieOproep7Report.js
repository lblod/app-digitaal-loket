...
export default {
  cronPattern: '0 0 0 * * *',
  name: 'gzgSubsidieOproepSevenReport',
  execute: async () => {
    const reportData = {
      title: 'List of GzG Report oproep 7, step 1',
      description: 'GzG subsidy forms of oproep 7, step 1',
      filePrefix: 'gzgSubsidieOproepSevenReport'
    };
      ...
      WHERE {
        {
          ...
          ?form dct:isPartOf/dct:references <http://data.lblod.info/id/subsidy-procedural-steps/9806caf4-d35c-4c6e-902a-2727d7a2626a> ;
            adms:status ?status;
