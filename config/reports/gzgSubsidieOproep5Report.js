...
export default {
  cronPattern: '0 0 0 * * *',
  name: 'gzgSubsidieOproepFiveReport',
  execute: async () => {
    const reportData = {
      title: 'List of GzG Report oproep 5, step 1',
      description: 'GzG subsidy forms of oproep 5, step 1',
      filePrefix: 'gzgSubsidieOproepFiveReport'
    };
      ...
      WHERE {
        {
          ...
          ?form dct:isPartOf/dct:references <http://data.lblod.info/id/subsidy-procedural-steps/99cc2dae-d83e-4a35-9715-21b46064cfc6> ;
            adms:status ?status;
