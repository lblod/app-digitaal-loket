...
export default {
  cronPattern: '0 0 0 * * *',
  name: 'gzgSubsidieOproepSixReport',
  execute: async () => {
    const reportData = {
      title: 'List of GzG Report oproep 6, step 1',
      description: 'GzG subsidy forms of oproep 6, step 1',
      filePrefix: 'gzgSubsidieOproepSixReport'
    };
      ...
      WHERE {
        {
          ...
          ?form dct:isPartOf/dct:references <http://data.lblod.info/id/subsidy-procedural-steps/80b5770f-f80b-42c8-bd7e-e7126fa0e00f> ;
            adms:status ?status;
