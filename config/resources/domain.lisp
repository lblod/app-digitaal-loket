...
(defparameter *cache-count-queries* nil) ;;Temporary disabled because sparql-parser is generating too much deltas
(defparameter *supply-cache-headers-p* nil
  "when non-nil, cache headers are supplied.  this works together with mu-cache.") ;;Temporary disabled because sparql-parser is generating too much deltas
(setf *cache-model-properties-p* nil) ;;Temporary disabled because sparql-parser is generating too much deltas
