...
(define-resource aanvraag ()
  ...
  :has-one `((aangevraagd-bedrag :via ,(s-prefix "subsidie:aangevraagdBedrag")
             ...
             (application-form :via ,(s-prefix "prov:used")
                               :as "application-form")
             (subsidiemaatregel-consumptie :via ,(s-prefix "prov:generated")
                               :as "subsidiemaatregel-consumptie"))
...
(define-resource engagement-table ()
  ...
  :resource-base (s-url "http://data.lblod.info/engagement-tables/")
  :features '(include-uri)
...
(define-resource engagement-entry ()
  ...
  :resource-base (s-url "http://data.lblod.info/engagement-entries/")
  :features '(include-uri)
