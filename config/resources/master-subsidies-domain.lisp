...
(define-resource application-form-entry ()
  ...
  :properties `((:actorName :string ,(s-prefix "ext:actorName"))
                (:numberChildrenForFullDay :number ,(s-prefix "ext:numberChildrenForFullDay"))
                (:numberChildrenForHalfDay :number ,(s-prefix "ext:numberChildrenForHalfDay"))
                (:numberChildrenPerInfrastructure :number ,(s-prefix "ext:numberChildrenPerInfrastructure"))
                (:totalAmount :number ,(s-prefix "ext:totalAmount")))
